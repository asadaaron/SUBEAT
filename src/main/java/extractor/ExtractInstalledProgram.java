...
public class ExtractInstalledProgram {
  ...
  public ExtractInstalledProgram(String dbUrl, String outputFileLocation, CSVConverter csvConverter, Map<String, String> placeholderMap) {
    this.dbUrl = dbUrl;
  ...
  public void installedProgramExtractor(){
    try  {
      ...
      System.out.println("Installed Program List extraction time: "+ TimeUnit.MILLISECONDS.convert(elapsedTime, TimeUnit.NANOSECONDS));
